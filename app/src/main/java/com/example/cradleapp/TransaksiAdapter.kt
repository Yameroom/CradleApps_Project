...
/* FILE INI DINONAKTIFKAN SEMENTARA (DIPAKAI JIKA BUTUH LOGIKA LAMA)
   SAAT INI MENGGUNAKAN ReportAdapter.kt UNTUK DATA AGA8
    ...
    override fun onBindViewHolder(holder: TransaksiViewHolder, position: Int) {
        ...
        holder.btnDelete.setOnClickListener {
            ...
            if (context is DataListActivity) {
                // Perbaikan: Hapus 'position' jika ingin un-comment nanti
                context.konfirmasiHapus(item.id)
            }
        }
    }
